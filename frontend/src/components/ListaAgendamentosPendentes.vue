<template>
  <div class="center">
   <div  v-if="agendamentos.length > 0">
     ...
     <ul class="card">
       <li v-for="agendamento in agendamentos" :key="agendamento.nomeConsulta">
...
export default {
 ...
 methods: {
   carregarAgendamentosPendentes() {
     const url = "http://127.0.0.1:8080/agendamentos/pendentes";
 ...
 mounted(){
   this.carregarAgendamentosPendentes()
 }
};
</script>
